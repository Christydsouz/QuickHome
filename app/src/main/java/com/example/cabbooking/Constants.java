...
public class Constants {
    ...
    public static class FSBooking {
        ...
        public static final String declinedDrivers = "declinedDrivers";
        public static final String rideOTP = "rideOTP";
        public static final String otpVerified = "otpVerified";
