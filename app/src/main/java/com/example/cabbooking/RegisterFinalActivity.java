...
//        data.put(Constants.FSUser.rating, 5.0);
        ...
        db.collection(Constants.FSUser.userCollection).add(data)
            .addOnSuccessListener(documentReference -> {
                Toast.makeText(RegisterFinalActivity.this, "User saved to Firestore successfully!", Toast.LENGTH_SHORT).show();
            })
            .addOnFailureListener(e -> {
                Toast.makeText(RegisterFinalActivity.this, "Failed to save user: " + e.getMessage(), Toast.LENGTH_LONG).show();
            });
    }
