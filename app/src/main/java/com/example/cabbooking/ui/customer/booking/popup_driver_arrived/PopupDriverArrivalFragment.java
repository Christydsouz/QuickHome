...
public class PopupDriverArrivalFragment extends DialogFragment {
    ...
    private void linkViewElements(View rootView){
        ...
        otpTextView = rootView.findViewById(R.id.otpTextView);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getBooking().observe(getViewLifecycleOwner(), new Observer<Booking>() {
            @Override
            public void onChanged(Booking booking) {
                if (booking != null && booking.getRideOTP() != null) {
                    otpTextView.setText(booking.getRideOTP());
                }
            }
        });
    }
