...
public class User {
    ...
    public User(String docId, String username, String phone, Date birthDate, String gender, String email, String role, String transportationType, String vehiclePlateNumber, List<Integer> rating, Double currentPositionLatitude, Double currentPositionLongitude, String profileImageUrl) {
        this.docId = docId;
